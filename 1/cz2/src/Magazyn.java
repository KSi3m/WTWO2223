...
public class Magazyn {
    ...
    public void wyswietlPorownaniePodatkow()
    {
        ...
        System.out.println("Po odliczeniu podatku liniowego "+ pobierzWartoscPoOpodatkowaniu(s.getPl()));
        System.out.println("Po odliczeniu podatku progresywnego "+ pobierzWartoscPoOpodatkowaniu(s.getPp()));
